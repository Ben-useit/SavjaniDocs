...
from .icons import  icon_reports_register_event

link_reports_activity = Link(
    #permissions=(permission_reports_view,),
    text=_('Upload Report'), view='reports:upload_report'
)
...
link_reports_register_event = Link(
    icon_class=icon_reports_register_event,
    args='object.id', text=_('Events'), view='reports:events'
)
link_reports_register_statistics = Link(
    text=_('Register Files Report'), view='reports:register_files_report'
)
