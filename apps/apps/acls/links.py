...
from .icons import icon_acl_list, icon_acl_new, icon_acl_edit_list
...
link_acl_edit_list = Link(
    args='resolved_object.pk',
    permissions=(permission_acl_view,), text=_('Share'), view='acls:acl_edit_list'
)
link_acl_edit_list_with_icon = Link(
    icon_class=icon_acl_edit_list, args='resolved_object.pk', 
    permissions=(permission_acl_edit,), text=_('Share'), view='acls:acl_edit_list'
)
